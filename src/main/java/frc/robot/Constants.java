...
public final class Constants {
    ...
    // auto
    public static int kDrumLimitSwitch = 0;// Itakes limit switch
    public static int kPhotoSensor1 = 1;// Intakes 1st photo sensor
    public static int kPhotoSensor2 = 2;// Intakes 2nd photo sensor
